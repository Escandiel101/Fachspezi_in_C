...
namespace ShopBackend.Application.Interfaces
{
    public interface IUserService
    {
        ...
        Task<IEnumerable<User>> GetAllAsync(); // man könnte auch List statt IEnumerable verwenden, aber die liste wäre weniger restriktiv,da sie mehr operationen unterstützt, wie z.B. hinzufügen oder entfernen von elementen, während IEnumerable nur das durchlaufen der elemente ermöglicht.
