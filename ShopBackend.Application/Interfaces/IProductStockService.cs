...
namespace ShopBackend.Application.Interfaces
{
    public interface IProductStockService // Interface für die Verwaltung von Produkten und deren Lagerbeständen
    {
        ...
        Task UpdateStockAsync(int productId, int quantity); // Methode zum Aktualisieren des Lagerbestands eines Produkts, z.B. nach einem Verkauf oder einer Rücksendung.
